    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        private async Task SeedAlimentos()
        {
            var alimentos = new[]
            {
                ...
                _alimentoFactory.Create("CHOCLO", "GRANOS", UnidadMedida.Gramo, new InfoNutricional(100, 96, 3.4m, 21, 1.2m)),
                ...
                _alimentoFactory.Create("PLATANO", "FRUTAS", UnidadMedida.Gramo, new InfoNutricional(100, 89, 1.1m, 23, 0.3m)),
                _alimentoFactory.Create("MANZANA", "FRUTAS", UnidadMedida.Gramo, new InfoNutricional(100, 52, 0.3m, 14, 0.2m)),
                _alimentoFactory.Create("NARANJA", "FRUTAS", UnidadMedida.Gramo, new InfoNutricional(100, 47, 0.9m, 12, 0.1m)),
